...
## INPUT
    ...
    if her2==-1:
        ...
        df_test_pCR = pd.read_csv('../inputs/external_test.csv')
    elif her2==2:
        df_test_pCR = pd.read_csv('../inputs/all.csv')
...
## MODELS
    ...
    for rcut in [1.0]:
        ...
        #pcr_refits = pickle.load(open('{}/{}_pcr_refits.pkl'.format(parent_folder, whichFeats), 'rb'))
        pcr_refits = pickle.load(open('../submissions/chemo_pcr_refits.pkl', 'rb'))
