...
## INPUT
    her2 = int(her2_str)
    df_train = pd.read_csv('../inputs/training_df2.csv')
...
## MODELS
    ...
    with open('../submissions/'+whichFeats+'_pcr_models.pkl', 'wb') as f:
        pickle.dump(pcr_models, f)
    with open('../submissions/'+whichFeats+'_pcr_refits.pkl', 'wb') as f:
